  ...
  return (
    <div className="flex flex-col gap-4  mb-[15vh]">
      {ListDoctor.map((doctor) => (
        <div key={doctor.id} className="flex w-[96%] ml-[2%] gap-1 justify-between pr-4 border border-[#BBC1C7] rounded-[15px]">
          <div className="flex ">
          ...
          <div className="flex flex-col gap-1 py-3 pl-2 pr-4 ">
            ...
            <div className="flex gap-1 items-center ">
                <img src="src\assets\icons\Star.svg" alt="rate"  className="w-[16px] "/>
                <p>{doctor.rating}</p>
            </div>
            <div className="flex gap-1 items-center">
                <img src="src\assets\icons\Clock Circle.svg" alt="date" className="w-[16px] "/>
                <p>{doctor.date}</p>
            </div>
            </div>
          </div>
