  ...
  return (
    <div>
      <div className="hidden lg:flex justify-evenly items-center px-16 pt-12">
        ...
        />
        <Link to="/map" className="flex justify-between items-center p-3 w-[100px] border border-2 border-[#BBC1C7] rounded-[10px] ">
          <img src="src\assets\icons\Routing 2.svg" alt="filter" />
