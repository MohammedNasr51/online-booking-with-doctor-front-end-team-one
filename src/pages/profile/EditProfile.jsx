      ...
      <form>
        <div className="flex flex-col items-center justify-center relative">
          ...
          <button
            ...
            className="w-[24px] h-[24px] absolute left-[62%] top-[78px] sm:left-[55%] bg-gradient-to-l from-[#145eb885] to-[#ffffff98]  rounded-full p-[1px] shadow-md hover:bg-gray-100 transition-colors"
          >
